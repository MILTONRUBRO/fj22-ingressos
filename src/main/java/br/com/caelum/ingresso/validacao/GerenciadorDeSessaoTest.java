...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDeUmHorarioDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime  horario = LocalTime.now();
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDeUmHorarioDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime  horario = LocalTime.now();
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes(){
		...
		Filme filme2 = new Filme("Rogue One", Duration.ofMinutes(90), "SCI-FI", BigDecimal.ONE);
